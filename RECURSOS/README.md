...
| Archivo             | Descripción                                                             |
| ------------------- | ----------------------------------------------------------------------- |
| `Presentacion.pptx` | Presentación editable (9+ diapositivas, lineamientos sustentación 2026) |
...
5. Ejemplo básico — cómo votan los árboles y qué explica SHAP
6. Resultados y demo — métricas + `/brotes`
7. Impacto — valor público y sostenibilidad
8. Repositorio — GitHub y documentación
9. Cierre — valor diferencial
